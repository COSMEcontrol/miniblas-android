...
@Module(injects = {ProfilesElementsFragmentCab.class, AplicacionPrincipal.class, BasketsElementsFragmentCab.class, VariablesElementsFragmentCab.class, NewVariableElementsFragmentCab.class,}, library = true)
public class RenderAdaptersModule{
	...
	@Provides
	SeleccionableRendererAdapter<MiniBlasCesta> provideCestasRendererAdapter(LayoutInflater layoutInflater, CestaRendererBuilder rendererBuilder){
	...
	@Provides
	SeleccionableRendererAdapter<MiniBlasItemVariable> provideVariablesRendererAdapter(LayoutInflater layoutInflater, VariableRendererBuilder rendererBuilder){
	...
	@Provides
	SeleccionableRendererAdapter<MiniBlasItemVariable> provideNuevaVariableRendererAdapter(LayoutInflater layoutInflater, NewVariableRendererBuilder rendererBuilder){
		MiniBlasItemVariableCollection itemVariableCollection = new MiniBlasItemVariableCollection(new ArrayList<MiniBlasItemVariable>());
		final SeleccionableRendererAdapter<MiniBlasItemVariable> adapter = new SeleccionableRendererAdapter<MiniBlasItemVariable>(layoutInflater, rendererBuilder, itemVariableCollection);
		return adapter;
	}
