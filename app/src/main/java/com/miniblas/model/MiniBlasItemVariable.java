...
public class MiniBlasItemVariable implements Comparable, ISortElement{
	...
	public static final MiniBlasItemVariable convertToMiniBlasVariable(ItemVariable _variable){
		MiniBlasItemVariable iv = new MiniBlasItemVariable(_variable.getName());
		iv.setTipo(_variable.getType());
		iv.setValor(_variable.get);
		return iv;
	}
...
*/
	...
	public String toString(){
		return "MiniBlasItemVariable [id=" + id + ", orden=" + orden + ", nombre=" + nombre + ", tipo=" + tipo + ", maximo=" + maximo + ", minimo=" + minimo + ", cesta=" + ", valor=" + valor + "]";
	}
