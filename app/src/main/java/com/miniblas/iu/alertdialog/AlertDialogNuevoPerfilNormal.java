...
public class AlertDialogNuevoPerfilNormal extends DialogFragment {
    ...
    public static AlertDialogNuevoPerfilNormal newInstance(IObservadorNewAlertDialog<MiniBlasPerfil> _observador, List<MiniBlasPerfil> _perfiles){
        AlertDialogNuevoPerfilNormal fragment = new AlertDialogNuevoPerfilNormal();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		alertBuilder.setTitle(activity.getResources().getString(R.string.nuevo_perfil));
