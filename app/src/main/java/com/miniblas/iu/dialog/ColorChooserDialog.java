...
import com.miniblas.views.CircleView;

/**
 * @author Aidan Follestad (afollestad)
 */
public class ColorChooserDialog extends android.app.DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                ...
                .neutralText(R.string.porDefecto)
                .positiveText(R.string.hecho)
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onNeutral(MaterialDialog dialog) {
                        ...
                        if (getArguments().getInt("title", 0) == R.string.primaryColor) {
                            getArguments().putInt("preselect", getResources().getColor(R.color.miniblas_color));
                        } else {
                            getArguments().putInt("preselect", getResources().getColor(R.color.miniblas_accent_color));
                        }
                        invalidateGrid();
                    }
                })
